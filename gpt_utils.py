...
- Продати: {', '.join(summary.get('sell_candidates', []))}
- Купити: {', '.join(summary.get('buy_candidates', []))}
...
Обов'язково:
1. Поясни, чому саме ці активи обрано для входу або виходу.
2. Якщо ринок падає — запропонуй тактику short-term відскоку або перенесення входу.
3. Уникай фраз типу “нічого не купувати”. Завжди знайди оптимальну точку входу або підготовку.
